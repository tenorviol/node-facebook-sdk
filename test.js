...
exports.testConstructor = function(test) {
	var facebook = new fbapi.Facebook({
		appId: APP_ID,
		secret: SECRET
	});
...
exports.testConstructorWithAllOptions = function(test) {
	var facebook = new fbapi.Facebook({
		appId: APP_ID,
		secret: SECRET,
		cookie: true,
...
exports.testNonUserAccessToken = function(test) {
	...
	test.equal(facebook.getAccessToken(), APP_ID+'|'+SECRET, 'Expect appId|secret.');
	test.done();
}
...
exports.testSetSession = function(test) {
	...
	test.equal(facebook.getAccessToken(), VALID_EXPIRED_SESSION.access_token, 'Expect access token back.');
	test.done();
}
