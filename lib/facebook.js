...
//   * @throws FacebookApiException
//   */
//  __graph : function (path, method = 'GET', params = array()) {
...
//   * @throws FacebookApiException
//   */
//  __oauthRequest : function (url, params) {
...
//   */
//  _makeRequest : function (url, params, ch=null) {
//    if (!ch) {
//      ch = curl_init();
//    }
//
...
//  }
  ...
  _getCurrentUrl : function () {
    ...
    var parts = url.parse(this.request.url);
